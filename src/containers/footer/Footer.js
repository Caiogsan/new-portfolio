                ...
                <div className="sm:w-[80%] w-[90%] m-auto flex">
                    <div className="w-[40%]">
                        <ul className="flex flex-col sm:flex-row gap-1 justify-between text-sm text-gray-400">
                            ...
                            <li className="hover:cursor-pointer duration-300 hover:text-blue-300"><Link to={"/new-portfolio/about"}>About</Link></li>
                            <li className="hover:cursor-pointer duration-300 hover:text-blue-300"><Link to={"/new-portfolio/project"}>Projects</Link></li>
                            <li className="hover:cursor-pointer duration-300 hover:text-blue-300"><Link to={"/new-portfolio/contact"}>Contact</Link></li>
                        </ul>
                    </div>
