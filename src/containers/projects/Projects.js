...
function Projects(){
    return (
        <div className="flex flex-col pb-32 pt-28 pt- font-navbar">
            <h1 className="text-2xl pb-12 font-bold">Website Academia Ultimate</h1>
            <div className="pb-12">
            ...
            <h1 className="text-2xl pb-12 font-bold">Projeto Chat GPT-3</h1>
            <div className="pb-12">
            ...
            <h1 className="text-2xl pb-12 font-bold">Tiago Tattoo</h1>
            <div className="pb-12">
            ...
            <h1 className="text-2xl pb-12 font-bold">Outros projetos</h1>
